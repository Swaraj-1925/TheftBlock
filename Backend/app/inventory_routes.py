...
@inventory_router.get("/{inventory_id}", response_model=InventoryDetailsResponse)
...
@inventory_router.get("/{inventory_id}/statistics", response_model=InventoryStatisticsResponse)
...
@inventory_router.get("/{inventory_id}/products", response_model=ProductDetailsResponse)
